...
def main():
    ...
    ## network setting
    parser.add_argument('--net_name', default='GNNSR', type=str, help='')
    ...
    ## dataloader setting
    parser.add_argument('--data_root', default='/home/zhuxb/ssd_data/zhy/GNNSR-SR-main/dataset/',type=str)
    ...
    parser.add_argument('--resume', default='./pretrained_weights/gnnsr_rec.pth', type=str)
